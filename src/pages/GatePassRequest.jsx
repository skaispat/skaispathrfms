  ...
  if (loading) {
    return (
      <div className="h-full flex flex-col gap-6 overflow-hidden bg-slate-50/30 px-4 sm:px-0">
        ...
        {/* Stats Grid Skeleton */}
        <div className="grid grid-cols-3 md:grid-cols-4 gap-3 sm:gap-6 shrink-0 animate-pulse">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className={`bg-white p-2.5 sm:p-5 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-200 flex flex-col items-center justify-center gap-1 sm:gap-2 ${i === 4 ? 'hidden md:flex' : ''}`}>
